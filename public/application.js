...
/***/ (function(module, exports, __webpack_require__) {
	...
	var startGame = __webpack_require__(7);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateGame = __webpack_require__(8).onUpdateGame;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onUpdateGame = function onUpdateGame(data) {
	  event.preventDefault();
	...
	var onGetGames = function onGetGames() {
	  event.preventDefault();
	  api.getGames().then(ui.getGamesSuccess).catch(ui.getsGamesFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signOutSuccess = function signOutSuccess(success) {
	  $('#change-password').hide();
	  $('#get-games').hide();
	  $('#new-game').hide();
	  $('#sign-out').hide();
